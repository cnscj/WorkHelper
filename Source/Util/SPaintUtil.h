...
namespace SPaintUtil
{
    ...
    void drawLine(QPainter &painter,const QPoint &a,const QPoint &b,int size = 1,const QColor &color = QColor(Qt::red));
    void drawPolygon(QPainter &painter,const QVector<QPoint> &points,int size = 1,const QColor &color = QColor(Qt::red));
